...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function() {
    ...
    Route::controller(ClassificationsController::class)->group(function () {
        Route::get('/classifications/edit/{id}', 'edit')->name('classifications.edit');
        Route::get('/classifications/destroy/{id}', 'destroy')->name('classifications.destroy');
    });

    Route::resource('badges', BadgesController::class);
    Route::controller(BadgesController::class)->group(function () {
        Route::get('/badges/edit/{id}', 'edit')->name('badges.edit');
        Route::get('/badges/destroy/{id}', 'destroy')->name('badges.destroy');
    });
    Route::get("/getUserClassificationsSelected/{id}",[ClassificationsController::class,"getUser"])->name("getUserClassificationsSelected");
    // Products
    ...
    Route::controller(ProductBulkUploadController::class)->group(function () {
        ...
        Route::get('/product-bulk-exports', 'exports')->name('product_bulk_exports.index');
    ...
    Route::controller(CustomerController::class)->group(function () {
        ...
        Route::post('/customers/classifications', 'classifications')->name('customers.classifications');
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::post('/order/save', 'save')->name('all_orders.save');
        ...
        Route::get('/session-save', 'sessionSave')->name('session-save');

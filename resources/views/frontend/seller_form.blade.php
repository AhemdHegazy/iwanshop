                    ...
                    <div class="bg-white border mb-4">
                        ...
                        <div class="p-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-2 mr-sm-2">
                                    <input type="password" class="form-control rounded-0" id="password_confirmation" placeholder="{{  translate('Confirm Password') }}" name="password_confirmation" required>

                                    <div class="input-group-prepend" onclick="showPassword('password_confirmation')">
                                        <div  class="input-group-text" style="height: 42px;"><i class="la la-eye-slash" style="font-size: 16px;" id="eye_password_confirmation"></i></div>
                                    </div>
                                </div>
                            </div>
                        </div>

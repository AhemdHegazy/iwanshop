...
<div class="aiz-titlebar text-left mt-2 mb-3">
	...
	<div class="align-items-center">
		<h1 class="h3">الوسوم (البادجات )</h1>
	</div>
</div>
		...
		<div class="card">
		    <div class="card-header row gutters-5">
				<div class="col text-center text-md-left">
					<h5 class="mb-md-0 h6">الوسوم</h5>
				</div>
				<div class="col-md-4">
					<form class="" id="sort_badges" action="" method="GET">
		            ...
		            <tbody>
		                @foreach($badges as $key => $brand)
		                    <tr>
		                        ...
		                        <td class="text-right">
{{--									@can('edit_brand')--}}
										<a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('badges.edit', ['id'=>$brand->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}" title="{{ translate('Edit') }}">
											<i class="las la-edit"></i>
										</a>
{{--									@endcan--}}
{{--									@can('delete_brand')--}}
										<a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('badges.destroy', $brand->id)}}" title="{{ translate('Delete') }}">

<div class="aiz-category-menu bg-white rounded-0 border-top" id="category-sidebar" style="width:270px;background: #eee">
    <ul class="list-unstyled categories no-scrollbar mb-0 text-left">
        @foreach (get_level_zero_categories()->take(10) as $key => $category)
            @php
                $category_name = $category->name;
            @endphp
            <li class="category-nav-element border border-top-0" style="background: #eee" data-id="{{ $category->id }}">

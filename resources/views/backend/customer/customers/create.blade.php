        ...
        <div class="card-body">
            <form action="{{ route('customers.store') }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{translate('Name')}}" value="{{old("name")}}" id="name" name="name" class="form-control" >
                        @error("name")
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{translate('Email Address')}}" value="{{old("email")}}" id="email" name="email" class="form-control">
                        @error("email")
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group  mb-3">
                            ...
                            <input type="tel" id="phone" class="form-control rounded-0" value="{{old("phone")}}"  placeholder="{{translate("Phone Number")}} " name="phone" autocomplete="off">

        ...
        <div class="sidemnenu">
            <ul class="aiz-side-nav-list mb-3 pb-3 border-bottom" data-toggle="aiz-side-menu">
               ...
               {{-- <li class="aiz-side-nav-item">
                ...
                <!-- Delete My Account -->
                <li class="aiz-side-nav-item">
                    <a onclick="account_delete_confirm_modal('{{ route('account_delete') }}')"  class="btn btn-danger text-white btn-block fs-14 fw-700 mb-5 mb-md-0" style="border-radius: 25px;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">

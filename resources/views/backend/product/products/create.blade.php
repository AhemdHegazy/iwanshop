    ...
    <div class="row">
        <div class="col-lg-6">
            <ul class="breadcrumb bg-transparent p-0 justify-content-center justify-content-lg-start">
                ...
                <li class="breadcrumb-item has-transition opacity-60 hov-opacity-100">
                    <a class="text-reset" href="{{ route('products.all') }}">{{ translate('Products') }}</a>
                </li>
        ...
        <div class="row gutters-5">
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <select class="form-control mb-3 aiz-selectpicker" data-live-search="true" name="category_ids[]" multiple>
                            @foreach ($categories as $category)
                                <option id="{{ $category->id }}" disabled value="{{ $category->id }}">{{ $category->name }}</option>
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-prepend">
                                    <span  class="input-group-text" style="height: 42px;" id="inputGroupPrepend">{{translate('Days')}}</span>
                                </div>
                            </div>
                        </div>
                    </div>

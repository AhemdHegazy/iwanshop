        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        2. {{ translate('حساب تكلفة الشحن بالسعر الثابت: لا يهم عدد المنتجات التي يشتريها العميل. تكلفة الشحن ثابتة') }}.
                    </li>
                    {{-- <li class="list-group-item">
                    ...
                    <li class="list-group-item">
                        4. {{ translate('حساب تكلفة الشحن المسطحة للمنطقة: معدل ثابت لكل منطقة. إذا قام العملاء بشراء منتجات متعددة من بائع واحد، فسيتم حساب تكلفة الشحن حسب منطقة شحن العميل. لتكوين تكلفة الشحن حسب المنطقة، انتقل إلى') }} <a href="{{ route('cities.index') }}">{{ translate('مدن الشحن') }}</a>.
                    </li>
                    {{-- <li class="list-group-item">
                        5. {{ translate('حساب تكلفة الشحن على أساس شركة النقل: حساب تكلفة الشحن بالإضافة إلى شركة النقل. في كل شركة نقل، يمكنك تعيين تكلفة شحن مجانية أو يمكنك تحديد نطاق الوزن أو تكلفة الشحن لنطاق السعر. لتكوين تكلفة الشحن على أساس شركة النقل، انتقل إلى ' ) }} <a href="{{ route('carriers.index') }}">{{ translate('شركات الشحن') }}</a>.
                    </li> --}}
                </ul>
            </div>
        </div>

            ...
            @can('reply_to_support_tickets')
                <form action="{{ route('support_ticket.admin_store') }}" method="post" id="ticket-reply-form" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-0 text-right">
                        <button type="submit" class="btn btn-sm btn-dark" onclick="submit_reply('replayed')">
                            أرسال كــ
                            <strong>
                                <span class="text-capitalize">
                                    {{ translate($ticket->status != "pending" ? $ticket->status : "Replayed")  }}
                                </span>
                            </strong>
                        </button>
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="#" onclick="submit_reply('replayed')">أرسال كــ <strong>تم الرد عليها </strong></a>
                            <a class="dropdown-item" href="#" onclick="submit_reply('solved')">أرسال كــ <strong>تم حلها </strong></a>
                            <a class="dropdown-item" href="#" onclick="submit_reply('closed')">أرسال كــ <strong>تم إغلاق التذكرة</strong></a>
                        </div>
                    </div>
                </form>
            @endcan

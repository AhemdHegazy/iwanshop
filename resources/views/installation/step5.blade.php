                    ...
                    <form method="POST" action="{{ route('system_settings') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control rounded-2 border" style="height: 36px !important;" id="admin_password" name="admin_password" required>
                                <div class="input-group-prepend" onclick="showPassword('admin_password')">
                                    <div  class="input-group-text" style="height: 42px;"><i class="la la-eye-slash" style="font-size: 16px;" id="eye_admin_password"></i></div>
                                </div>
                            </div>
                        </div>

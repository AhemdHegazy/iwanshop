    ...
    <div class="home-banner-area mb-3" style="">
        <div class="container">
            <div class="d-flex flex-wrap position-relative">
                <div class="position-static d-none d-xl-block" style="background: #eee">
                                                ...
                                                @if ($flash_deal_product->product != null && $flash_deal_product->product->published != 0)
                                                    ...
                                                    <div
                                                        ...
                                                        <a href="{{ $product_url }}"
                                                            ...
                                                            title="{{ $flash_deal_product->product->name }}">
                                                            <!-- Image -->
                                                            <img src="{{ get_image($flash_deal_product->product->thumbnail) }}"
                                                                ...
                                                                alt="{{ $flash_deal_product->product->name }}"
                                        ...
                                        <div class="row hov-scale-img">
                                            ...
                                            <div class="col">
                                                <h3
                                                    ...
                                                    <a href="{{ route('customer.product', $classified_product->slug) }}"
                                                        class="d-block text-reset hov-text-primary">{{ $classified_product->name }}</a>
                                                </h3>

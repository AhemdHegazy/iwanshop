                      ...
                      @foreach ($tickets as $key => $ticket)
                          <tr>
                              ...
                              <td>
                                  ...
                                  @elseif ($ticket->status == 'replayed')
                                      <span class="badge badge-inline badge-success p-3 fs-12" style="border-radius: 25px; min-width: 80px !important;">{{ translate('Replayed')}}</span>
                                  @else

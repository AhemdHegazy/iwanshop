        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="mb-0 h6">{{translate('إعداد جوجل reCAPTCHA')}}</h3>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('google_recaptcha.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            <div class="col-md-2">
                                <label class="control-label">{{translate('جوجل reCAPTCHA')}}</label>
                            </div>
                            <div class="col-md-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <label class="control-label">{{translate('المفتاح')}}</label>
                            </div>
                            <div class="col-md-8">

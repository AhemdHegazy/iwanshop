                        ...
                        @if (count($order->orderDetails) > 0)
                            <tr>
                                ...
                                <td class="text-right pr-0">
                                    ...
                                    <a class="btn btn-soft-secondary-base btn-icon btn-circle btn-sm hov-svg-white mt-2 mt-sm-0" href="{{ route('invoice.image', $order->id) }}" target="_blank" title="تحميل كصورة">

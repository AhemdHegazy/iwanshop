...
<section class="py-3 text-light footer-widget border-bottom pt-5" style="border-color: #0f7d7a   !important; background-color: #0f7d7a   !important;">
    <div class="container">
        <!-- footer logo -->
        <div class="row">
            <!-- about & subscription -->
    ...
    <div class="row align-items-center gutters-5">
        ...
        <div class="col">
            @if (Auth::check())
                ...
                @elseif(isSeller())
                    <a href="{{ route('dashboard') }}" class="text-white d-block text-center pb-2 pt-3">
                        <span class="d-block mx-auto">
                            @if($user->avatar_original != null)
                                <img src="{{ $user_avatar }}" alt="{{ translate('avatar') }}" class="rounded-circle size-20px">
                            @else

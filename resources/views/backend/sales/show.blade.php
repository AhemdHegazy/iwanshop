        ...
        <div class="card-body">
            <div class="row gutters-5">
                ...
                @if ($order->seller_id == $admin_user_id || get_setting('product_manage_by_admin') == 1)
                    ...
                    <div class="col-md-3 ml-auto">
                        ...
                        @if (auth()->user()->can('update_order_delivery_status') && $delivery_status != 'delivered' && $delivery_status != 'cancelled')
                            <select class="form-control aiz-selectpicker" data-minimum-results-for-search="Infinity"
                                ...
                                <option value="on_the_way" @if ($delivery_status == 'rejected') selected @endif>
                                    {{ translate('Rejected') }}
                                </option>
                    ...
                    <div class="col-md-12 mt-2 mb-2">
                        <form action="{{route("all_orders.save")}}" method="POST">
                            @csrf
                            <div class="form-group">
                                <input type="hidden" name="id" value="{{$order->id}}">
                                <label for="update_delivery_status">{{ translate('Order Notes') }}</label>
                                <textarea name="notes" id="notes" class="form-control" cols="30" rows="10" placeholder="{{translate("Please Write Note Here")}}">{{$order->notes}}</textarea>
            ...
            <div class="clearfix float-right">
                ...
                <div class="no-print text-right">
                    ...
                    <a class="btn btn-icon btn-light" href="{{ route('invoice.image', $order->id) }}" target="_blank" title="تحميل كصورة">

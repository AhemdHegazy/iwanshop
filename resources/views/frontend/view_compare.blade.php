                                        ...
                                        <div class="border">
                                            ...
                                            <div class="p-4 border-bottom">
                                                ...
                                                <h5 class="mb-0 text-dark h-45px text-truncate-2 mt-1">
                                                    <a class="text-reset fs-14 fw-700 hov-text-primary" href="{{ route('product', get_single_product($item)->slug) }}" title="{{ get_single_product($item)->name }}">
                                                        {{ get_single_product($item)->name }}
                                                    </a>
                                                </h5>
                                            </div>
                                            <!-- Product Image -->
                                            ...
                                            <div class="p-4 border-bottom">
                                                ...
                                                <h5 class="mb-0 fs-14 text-dark mt-1">
                                                    @if (get_single_product($item)->main_category != null)
                                                        {{ get_single_product($item)->main_category->name }}
                                                    @endif
                                                </h5>
                                            </div>
                                            <!-- Brand -->
                                            <div class="p-4 border-bottom">
                                                ...
                                                <h5 class="mb-0 fs-14 text-dark mt-1">
                                                    @if (get_single_product($item)->brand != null)
                                                        {{ get_single_product($item)->brand->name }}
                                                    @endif
                                                </h5>
                                            </div>
                                            <!-- Add to cart -->

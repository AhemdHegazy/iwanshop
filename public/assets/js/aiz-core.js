        ...
        updateUploaderFiles: function () {
            ...
            setTimeout(function () {
                ...
                if (data.length > 0) {
                    ...
                    $(".aiz-uploader-all").html(
                        '<div class="align-items-center d-flex h-100 justify-content-center w-100 nav-tabs"><div class="text-center"><h3>لا يوجد ملفات</h3></div></div>'
                    );
                }
    ...
    AIZ.extra = {
        ...
        deleteConfirm: function () {
            ...
            $(".confirms-delete").click(function (e) {
                ...
                $.ajax({
                    type:"GET",
                    url: '/admin/getUserClassificationsSelected'+'/'+id,
                ...
                $("#deletes-modal").modal("show");
                $("#deletes-link").attr("href", url);
            });

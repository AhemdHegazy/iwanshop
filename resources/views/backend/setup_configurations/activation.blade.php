...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <div class="clearfix">
                        <img class="float-left" src="{{ asset('assets/Sala/zin.png') }}" class="img-fluid" style="width: 100%;">

                    </div>
                    <label class="aiz-switch aiz-switch-success mt-2">
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <img class="" src="{{ asset('assets/img/cards/cod.png') }}" class="img-fluid" style="width: 100%;">
                    <label class="aiz-switch aiz-switch-success mt-2 ">
    ...
    <h4 class="text-center text-muted mt-4 mb-2">{{ translate('Social Media Login') }}</h4>
    <hr>
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <img class="float-left" src="{{ asset('assets/Sala/facebook.png') }}" class="img-fluid2" style="width: 100%;">
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <img class="float-left" src="{{ asset('assets/Sala/google.png') }}" class="img-fluid2" style="width: 100%;">
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <img class="float-left" src="{{ asset('assets/Sala/twitter.png') }}" class="img-fluid2" style="width: 100%;">
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    <img class="float-left" src="{{ asset('assets/Sala/apple.JPEG') }}" class="img-fluid2" style="width: 100%;">

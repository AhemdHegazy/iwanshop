            ...
            <div class="row gutters-5">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        @foreach ($categories as $category)
                        <div class="card-body categories" id="category_ids_div_{{$category->id}}" style="display: none">
...
@section('script')
    ...
    <script type="text/javascript">
        $("#category_id").change(function (){
            $(".categories").fadeOut()
            $("select[category_ids] >option").prop("selected",false)
            $("#category_ids_div_"+$(this).val()).fadeIn()

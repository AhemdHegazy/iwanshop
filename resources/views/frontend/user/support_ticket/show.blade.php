        ...
        <div class="card-body">
            ...
            <form action="{{route('support_ticket.seller_store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-0 text-right">
                    <button class="btn btn-sm btn-primary rounded-0 w-150px" onclick="submit_reply('replayed')">أرسال الرد</button>
                    <br>
                    <br>
                    <button  class="btn btn-sm btn-danger rounded-0 w-150px" onclick="submit_reply('closed')">أرسال و أغلاق التذكرة </button>
                    <button class="btn btn-sm btn-success rounded-0 w-150px" onclick="submit_reply('solved')">أرسال كتم حلها </button>
                </div>
            </form>
            @else
                <div class="alert alert-success">
                    تم أنهاء هذه التذكرة
                </div>
            @endif
            <div class="pad-top">

            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST"
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label">{{translate('Whatsapp Phone Number Sender')}}</label>
                            <div class="col-sm-9">
                                <input type="hidden" name="types[]" value="whatsapp_phone_send">

                                <div class="input-group  mb-3">
                                <input type="text" class="form-control mb-3" placeholder="{{ translate('Whatsapp Phone Number Sender')}}" name="whatsapp_phone_send" value="{{  get_setting('whatsapp_phone_send') }}" required>
                                <div class="input-group-prepend">
